...
Music making in 16th Century England was practical, something that is reflected in many of the writings of music during this time. 
...
With this logic, the hexachords could start on one of three letters: C (natural hexachord), F (soft hexachord), and G (hard hexachord). The softe hexachord is an interesting case because it contains the flat B to accomadate a half step from A to B-Flat. Because not all pieces remained in the small space of six notes, the meant singers needed to mutate between the natural hexachord and either the soft or hard depending on wether or not the piece had a flat in it. Along with the gamut and hexachords, a clefe was also used to help identify where notes would be sung. These clefs are derived from the same notes that the hexachords are built from F, C, and G named according to their placement on the gamut.
...
This finding supports the importance of the Gamut in teaching and instructring musicans to sing that is derived from a close reading of the text. The note is the primary building block of pitch space in English Theory, representing both the act of creating music and the pitch that is meant to be sung in relation to the gamut. Notes are represented through they names given on the gamut and are used to describe both the concepts of cleif and key. The term note is used consistantly throughout the documents almost emphasizing the practicality of the writing. 
...
Both Morley and Bathe call the naming of notes the “Scale of Musicke,” in relation to the concepts of solfege, their placement on lines and spaces, and the clefs that help to define them. Interestingly, they have almost the same thing to say in terms learning to sing the Gamutt: 
...
This could indicate many things, but does show a tendency to view the Gamut as the starting point for understanding and engaging with music. 

<img width="409" alt="Screen Shot 2021-06-05 at 3 42 35 PM" src="https://user-images.githubusercontent.com/72164586/120906194-a8e29800-c614-11eb-820f-58a67c6e1ed1.png">
...
In particular the topic deemed "The Gamut" is associated with differet words that indicate pitch space in Renaissance Theory. This topic deals with where notes are placed on the spaces and lines and the order in which they exist.  


# Conclusions

The use of tools like Voyant and Mallet can help to contextualize and solidify aspects of these texts that support the idea that pitch space was tied to the Gamut in 16th Century English Theory and that the texts themselves were aimed heavily at the practice of music making in realtion to these theoretical ideas. To furthur thus research, the corpus could be expanded to include more variety of musical texts about music from otehr English composers. Additionally, a comparison between topics in English Texts and Latin/Italian texts might indicate differences between ways of teaching and conceptualizing pitch space in different cultures or bring to light similarities between ideas between composer from different continents.
